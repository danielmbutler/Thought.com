...
var SyncEngine = /** @class */ (function () {
    function SyncEngine(schema, namespaceResolver, modelClasses, userModelClasses, storage, modelInstanceCreator, maxRecordsToSync, syncPageSize, conflictHandler, errorHandler, syncPredicates) {
        this.schema = schema;
        ...
        this.subscriptionsProcessor = new subscription_1.SubscriptionProcessor(this.schema, this.syncPredicates);
