...
export default function Profile() {
    ...
    fetch('Thought Profile API', requestOptionsProfile)
    .then(res => res.json())
    .then(
        (result) => {
            //console.log(result);
                ...
                Likebutton.onclick = function() { 
                   ...
                   // console.log(LikedBy);
                    ...
                    if(LikedBy.includes(Auth.user.attributes.email)){
                        ...
                        fetch('LIKES API', requestOptionsLike)
                        .then(res => res.json())
                        .then(
                            (result) => {
                                    //console.log(result);
                            ...
                            fetch('NOTIFICATIONS API', NotificationPost)
                            .then(res => res.json())
                            .then(
                                (result) => {
                    ...
                    if(LikeCount <=0){
                        ...
                        document.getElementById(this.id.replace("unlike","like")).disabled = false;
                            ...
                            if(!LikedBy.includes(Auth.user.attributes.email)){
                                ...
                                fetch('LIKES API', requestOptionsUnLike)
                                .then(res => res.json())
                                .then(
                                    (result) => {
                                            //console.log(result);
            ...
            data.forEach(function(obj,index){
                ...
                if(obj.attachment){
                    //console.log("S3/" + imglink + "/" + obj.attachment);
                    var entry = document.createElement('li');
        ...
        followlocation.onclick = async function(){
                ...
                if(followed === true){
                    ...
                    fetch('FOLLOW API', requestOptionsUnFollow)
                    .then(res => res.json())
                    .then(
                        (result) => {
                                console.log(result);
                    ...
                    fetch('FOLLOW API', requestOptionsFollow)
                    .then(res => res.json())
                    .then(
                        (result) => {
                                console.log(result);
        ...
        fetch('USER API', requestOptionsAccountInfo)
        .then(res => res.json())
        .then(
            (result) => {
                    //console.log(result);
